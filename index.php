...
var map = new ol.Map({
  ...
  new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_KPL_Environmental_Safeguard_Peta_Dasar_250K/MapServer',
			}),
		name: 'World Label',
		LegenUrl:'',
		LegentType :'ESRI',
  ...
  new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_RTRWP_AR_250K/MapServer',
			}),
		name: 'World Label',
		LegenUrl:'',
		LegentType :'ESRI',
